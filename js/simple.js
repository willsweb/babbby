            ...
            if (buttonid == 'audio') {
                $.getJSON('audio.php', function(data) {
                    ...
                    audio[0].addEventListener('ended',function(e){
                        ...
                        audio[0].src = $(playlist.find('a')[current]).attr('href');
                        par = $(playlist.find('a')[current]).parent();
                        par.addClass('active').siblings().removeClass('active');
                        audio[0].load();
                        audio[0].play();
                        var scrolltext = $(playlist.find('a')[current]).attr('title');
                        $('div.scrollingtext').text(scrolltext);
                    });
                });
                scroller_obj.css({
